...
namespace WPFTaskbarNotifier
{
    public class SysTray : IDisposable
    {
        ...
        public SysTray(string text, ImageSource icon)
        {
            m_loopCount = 0;
            m_notifyIcon = new NotifyIcon {Text = text, Visibility = Visibility.Visible, Icon = icon};
            m_DefaultIcon = icon;
        ...
        public void ShowText(string text, Font font, Color col)
        {
            ...
            m_notifyIcon.Icon = Imaging.CreateBitmapSourceFromHBitmap(bitmap.GetHbitmap(), IntPtr.Zero,
                                                                             Int32Rect.Empty,
        ...
        private readonly Color m_col = Color.Black;
        private Icon[] m_animationIcons;
        private readonly Timer m_timer;
        private int m_currIndex;
        private int m_loopCount;
        private readonly ImageSource m_DefaultIcon;
